module.exports = {
  ...
  applications: [
    {
      id: "app-1",
      studentUserId: "user-student-aarav",
    ...
    "job-google-swe-intern": [
      {
        ...
        status: "Shortlisted",
        score: 92,
        note: "Strong React and backend profile with placement-cell tooling project.",
      },
      {
        id: "cand-2",
        name: "Ananya Rao",
  ...
  notifications: [
    {
      ...
      body: "Microsoft technical interview is scheduled for 12 Apr at 10:00 AM.",
      read: false,
    },
    {
      id: "note-2",
      ...
      body: "Your primary resume version is now attached to new applications.",
      read: true,
    },
  ],
  adminOverview: {
